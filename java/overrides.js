module.exports = {
    ...
    'check window fully with fixed scroll root element': {config: {branchName: 'v1'}}, // diffs if compare to common baseline
    ...
    'check frame fully with css stitching': {config: {branchName: 'v1'}}, // diffs if compare to common baseline
