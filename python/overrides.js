module.exports = {
    ...
    'check window fully with fixed scroll root element': {config: {parentBranchName: 'current_python', branchName: 'current_python'}}, // diffs if compare to common baseline
